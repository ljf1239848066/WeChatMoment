...
import com.lxzh123.lrecyclerview.util.WeakHandler;
import com.lxzh123.wechatmoment.R;

/**
 * description: 微信朋友圈下来刷新头
...
public class MomentsRefreshHeader extends FrameLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        inflate(getContext(), R.layout.layout_moments_header, this);
        mRefreshView = findViewById(R.id.iv_refresh);
        measure(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        mHeaderViewHeight = getMeasuredHeight();
        mRefreshHideTranslationY = -30;
        mRefreshShowTranslationY = mRefreshView.getMeasuredHeight() * 4;
    }
