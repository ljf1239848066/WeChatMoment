...
import com.lxzh123.wechatmoment.view.ViewPagerAdapter;
...
//                View view=layoutInflater.inflate(R.layout.image_viewer_item,null);
                ...
                MatrixImageView imageView = (MatrixImageView) view.findViewById(R.id.iv_tweet_image);
...
//                imageView.setOnTouchListener(new MulitPointTouchListener());
    ...
    public void startDrag() {
        viewPager.setmChildIsBeingDragged(true);
    }


    @Override
    public void stopDrag() {
        viewPager.setmChildIsBeingDragged(false);
    }
