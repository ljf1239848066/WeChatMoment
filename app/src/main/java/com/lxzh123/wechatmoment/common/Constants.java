...
public class Constants {
     ...
     */
    public final static int DEFAULT_LOAD_TIMEOUT = 2000;
     ...
     * 朋友圈状态图片默认加载缩放系数
     */
    public final static float IMG_THUMB_SCALE = 0.2f;
    /**
     * 朋友圈状态图片最大显示列数
     */
    public final static int TWEET_IMG_GRID_MAX_COLUMN = 3;
}
