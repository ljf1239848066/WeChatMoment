...
public class GlideImageLoader implements INineGridImageLoader {
    public static int[] IMG_HOLDER_IDS = {
            R.drawable.default_img_1, R.drawable.default_img_2, R.drawable.default_img_3,
            R.drawable.default_img_4, R.drawable.default_img_5, R.drawable.default_img_6,
            R.drawable.default_img_7, R.drawable.default_img_8, R.drawable.default_img_9};
